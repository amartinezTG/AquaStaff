          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-4">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Ingresos <span>| Mes actual</span></h5>
            ...
            <div class="col-xxl-4 col-md-4">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Clientes <span>| Mes actual</span></h5>
                  ...
                  <div class="card-body">
                    ...
                    <form class="row g-3">
                      <div class="col-md-3">
                        ...
                        <div class="col-sm-10">
                          <select class="form-select" id="colorselector" aria-label="Default select example">
                            <option >--</option>
