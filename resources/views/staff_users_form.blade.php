                ...
                <div class="card-body">
                  ...
                  <form class="row g-3" method="POST" action="{{ route('usuario') }}">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <label for="inputText" class="col-sm-5 col-form-label">Correo Electrónico</label>
                        <div class="col-sm-12">
                          <input type="text" class="form-control" name="email" tabindex="2" value="@if (isset($user->email)){{$user->email}}@endif" required>
                        </div>
                      </div>
